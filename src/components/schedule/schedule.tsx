...
import TeamList, { THE_ENTIRE_TEAM_ID } from '@/components/schedule/team-list';
...
function isEntireTeamId(teamId: number) {
  ...
  return teamId === THE_ENTIRE_TEAM_ID;
}

export default function Schedule() {
  const [selectedTeamId, setSelectedTeamId] = useState(THE_ENTIRE_TEAM_ID);
